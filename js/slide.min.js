!function (e) {
    e.fn.slideCarsousel = function (t) {
        ...
        var i = e(this), n = i.children("ul.item-list"), r = n.children(),
            s = {
                slideCarousel: i, count: r.length, ul: n, liList: r,
                currentIndex: 0, indicatorList: i.children(".indicator-list").children("a"),
                itemPrev: i.children(".control").children(".icon-chevron_left"),
                itemNext: i.children(".control").children(".icon-chevron_right"),
                ...
                toNext: function () {
                    s.itemClassArr.unshift(s.itemClassArr[s.count - 1]), s.itemClassArr.pop(), s.currentIndex++,
                    s.currentIndex = s.currentIndex >= s.count ? 0 : s.currentIndex, s.resetItemClass()
                }, toPrev: function () {
                    s.itemClassArr.push(s.itemClassArr[0]),
                    s.itemClassArr.shift(), s.currentIndex--, s.currentIndex = s.currentIndex < 0 ? s.count - 1 : s.currentIndex,
                    s.resetItemClass()
                }, processIndicatorEvent: function (t) {
                    var i = t - s.currentIndex; if (0 != i) {
        ...
        switch (s.init(), s.itemNext.click(function () { s.toNext() }), s.itemPrev.click(function () { s.toPrev() }), t.indicatorEvent) {
            case "click": s.indicatorList.click(function () { s.processIndicatorEvent(e(this).attr("data-slide-index")) });
                break; case "mouseover": s.indicatorList.mouseover(function () { s.processIndicatorEvent(e(this).attr("data-slide-index")) })
        }switch (t.slideType) {
            case "2d": break; case "3d": s.ul.on("click", ".item1 img", function () { s.toPrev() }), s.ul.on("click", ".item3 img",
                function () { s.toNext() })
    ...
    e.fn.slideCarsousel.defaultSetting = {
        ...
        isAutoChange: !0, direction: 5e3, //切換速度為5
        callbackFunc: null, 
